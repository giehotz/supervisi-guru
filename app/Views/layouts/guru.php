...
<head>
    ...
    <title>Guru Dashboard - Sistem Supervisi</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
            // Cek apakah user juga memiliki akses supervisor
            $supervisorModel = new \App\Models\SupervisorModel();
            $isSupervisor = $supervisorModel->where('user_id', session()->get('id'))->where('status', 'Aktif')->countAllResults() > 0;
            if ($isSupervisor):
            ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('/supervisor') ?>">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Dashboard Supervisor</span></a>
                </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('/guru/hasil') ?>">
                    <i class="fas fa-fw fa-chart-bar"></i>
                    <span>Hasil Supervisi</span></a>
            </li>

            <!-- Nav Item - Dokumen Ajar -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('/guru/dokumen-ajar') ?>">
                    <i class="fas fa-fw fa-folder-open"></i>
                    <span>Dokumen Ajar</span></a>
            </li>
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('/guru/profile/edit') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= base_url('/guru/profile/edit') ?>">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Logout" di bawah ini jika Anda sudah siap untuk mengakhiri sesi Anda saat ini.</div>
